...
is monkeypatched (never a real socket) for the default `LiteratureSearchClient`
...
def mock_workspace_manager():
    ...
    with (
        ...
        patch("src.nodes.llm.literature_researcher.WorkspaceManager") as mock_wm_cls_node,
    ):
